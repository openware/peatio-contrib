RSpec.describe Peatio::Fireblock::Wallet do
  # let(:wallet) { Peatio::Fireblock::Wallet.new }
  ...
  #     expect(wallet.settings).to eq(settings.slice(*Peatio::Fireblock::Wallet::SUPPORTED_SETTINGS))
  #   end
  # end
